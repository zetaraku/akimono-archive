...
ここで，まずギフト券を「入門本セットと交換」しましょう。 
これらの本があれば，加工する技術はいちおう手に入れたことになります。

・<SPAN>材料を調達する</SPAN>
次に，材料を調達するには，近くの山への地図を市場から購入します。
買ったら，その地図を使用します。試しに「林道を探索」してみてください。
木の枝がたくさんとれたと思います。これが木工細工の場合の材料になります。
