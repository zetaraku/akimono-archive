...
・<SPAN>まずは仕入れ</SPAN>
とりあえず元手の２０万円を増やすには，まず【取引】に分類されている[市場]へ
向かいます。この世界の卸売り市場です。ここで，とりあえずポーション，エーテルの
...
ここで，まずギフト券を「初心者セットと引き換え」ましょう。 
本執筆キットで「薬剤師初級を執筆」すれば，本が作成できます。
本があれば，加工する技術はいちおう手に入れたことになります。
または，調理師を目指すのであれば「モーモーと引き換え」たほうがいいかもしれません。

・<SPAN>材料を調達する</SPAN>
次に，材料を調達するには，探索のススメを使用します。
試しに「世界樹のふもとへ」行ってみてください。
世界樹の枝がたくさんとれたと思います。これが木工細工の場合の材料になります。
他の場所を回ると，別な物を集めることができるでしょう。
なお，この材料そのものを売ってもいいのですが，この世界では材料はほとんど売れません。

・<SPAN>商品を加工する</SPAN>
材料がそろったら，先ほど手に入れた本を使用して，商品が作れるようになります。
...
$CONTENT[8]=<<'HTML';
・<SPAN>世界樹とは</SPAN>
世界樹はこの街のシンボルツリーです。マナ水をあげることで生命力を取り戻します。
決算時に，生命力に応じてボーナスがあります。
また，生命力は決算時に少しずつ減少していきます。
あまり生命力が減ってしまうと，経営が思うようにいかなくなってしまうかもしれません。

・<SPAN>水をあげるには</SPAN>
水をあげるには，【施設】の[世界樹]に行きます。
1回につき，マナ水1本と時間を20分消費します。1日にあげられる回数には上限があります。
基本的にはボランティアですが，たくさん水をあげると何か良いことが起きるかもしれません。

・<SPAN>世界樹の開花</SPAN>
決算時に生命力が一定以上になっていると，世界樹は開花をします。
開花すると世界樹の花が手に入ります。が，樹の生命力は大きく減少してしまいます。
同時に，開花数に応じて樹の周辺に実が落ちてきます。
探索をすれば拾うことができますが，落ちている数には限りがあり，早い者勝ちです。
なお，実は次の決算を迎えると消えてしまいますので，早めに拾っておいたほうが良いでしょう。
HTML
# ここまで。上の「HTML」は削除してはいけません。------------------------------
